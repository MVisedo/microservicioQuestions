...
import * as articleExistConsumer from "./rabbit/articleExistConsumer";
import * as logOutConsumer from "./rabbit/logoutConsumer";
...
articleExistConsumer.init();
logOutConsumer.init();


app.listen(conf.port, () => {
  console.log(`Q&A Server escuchando en puerto ${conf.port}`);
});
